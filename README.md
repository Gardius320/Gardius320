...
💰 Katame — Finanzas personales y productividad (PWA) Monolito modular en ASP.NET Core · 54 endpoints REST · 161 pruebas automatizadas · JWT con rotación de refresh token 🔗 Demo en producción
